...
export default function NotFound() {
  return (
    <AppShell title="Page not found — Parivekshan AI">
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-space-lg py-space-xl">
        <div className="rounded-2xl border border-border-crisp bg-surface-card shadow-card p-space-xl max-w-md w-full text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-risk-critical-bg text-error mb-4">
